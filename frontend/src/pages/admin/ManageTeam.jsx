                    ...
                    >
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                {/* Instagram */}
                                <div>
                                    <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-widest">Instagram URL <span className="text-gray-400 font-normal normal-case">(optional)</span></label>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-9 bg-gray-50 dark:bg-black/50 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white rounded-xl px-4 py-3 focus:outline-none focus:border-pink-500/60 transition-colors placeholder-gray-400 text-sm font-medium"
                                        />
                                    </div>
                                </div>
                                ...
                                {/* LinkedIn */}
                                <div>
                                    <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-widest">LinkedIn URL <span className="text-gray-400 font-normal normal-case">(optional)</span></label>
                                    <div className="relative">

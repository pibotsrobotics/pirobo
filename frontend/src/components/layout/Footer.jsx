                    ...
                    <div className="space-y-10">
                        ...
                        <div>
                            ...
                            <div className="flex gap-4">
                                ...
                                <a href="#" className="w-10 h-10 rounded-full bg-gray-900 border border-white/5 flex items-center justify-center text-gray-400 hover:bg-red-600 hover:text-white hover:border-red-500 hover:shadow-[0_0_15px_rgba(220,38,38,0.4)] transition-all duration-300 transform hover:-translate-y-1">
                                    <Youtube size={18} />
                                </a>
                            </div>
                        </div>
